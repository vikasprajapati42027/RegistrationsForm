...
<html>
    ...
    <body style="background-color:powderblue;">
        <%
            ...
            if(dao.Insert(obj.getFullname(),obj.getEmail(),obj.getPass(),obj.getDob(),obj.getGender())>0)
            {
                out.println("<script>alert('Data inserted');window.location.href='login.jsp';</script>");
            }
            else
            {
